...
def main():
    ...
    parser_construct.add_argument('-m', '--is_mono',
                                  ...
                                  action="store_true")
    parser_construct.add_argument('--ovlp_ratio', help="threshold of gene pair coordinate overlap "
                                                       "identified by GMAP, default: 0.8", type=float, default=0.8)
    parser_construct.add_argument('-b', '--blast_count', help="blast count, default: 2",
                                  type=int, default=2)
    parser_construct.add_argument('--blast_identity', help="threshold of blast identity, default: 80",
